...
function Home({allProducts}) {
    ...
    const clickdoughType = (doughType) => {
                    ...
                    return(
                      <div className="pizza-block">
                          ...
                          <div className="pizza-block__selector">
                            <ul>
                              <li onClick={() => clickdoughType("delicate")} className={doughType === "delicate" ? "active": ""}>тонкое</li>
                              <li onClick={() => clickdoughType("trad")} className={doughType === "trad" ? "active": ""}>традиционное</li>
                            </ul>
                            <ul>
                              <li className={size === 26 ? "active": ""}>26 см.</li>
                              <li className={size === 30 ? "active": ""}>30 см.</li>
                              <li className={size === 40 ? "active": ""}>40 см.</li>
                            </ul>
                          </div>
